...
var Marker = /** @class */ (function () {
    ...
    Marker.colors = {
         ...
         *          times in the array)
         */
        autoColorFromStates: function (states, colorSet) {
            if (colorSet === void 0) { colorSet = Marker.colorSets.colorBrewer; }
            var stateCounts = states.reduce(function (acc, state) {
                if (state) {
                    if (!acc[state]) {
                        acc[state] = 0;
                    }
            ...
            var sortedStateCountTuple = Object.entries(stateCounts).sort(function (a, b) {
                if (a[1] === b[1]) {
                    return 0;
                }
                return a[1] > b[1] ? -1 : 1;
            });
            var stateToColor = sortedStateCountTuple.reduce(function (acc, stateCountTuple, idx) {
