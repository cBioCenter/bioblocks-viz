...
export interface IContactContainerState {
  tsne: tsnejs.tSNE;
}

export class ContactContainer extends React.Component<any, IContactContainerState> {
  ...
  public render() {
    return <ContactComponent data={this.state.tsne.getSolution()} />;
  }
