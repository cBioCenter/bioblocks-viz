...
import { CELL_TYPE, SPRING_DATA_TYPE } from '../data/chell-data';
...
class SpringComponentClass extends React.Component<ISpringComponentProps, any> {
  ...
  constructor(props: ISpringComponentProps) {
    super(props);
  }
...
type requiredProps = Omit<ISpringComponentProps, keyof typeof SpringComponentClass.defaultProps> &
  Partial<ISpringComponentProps>;
